...
--> statement-breakpoint
CREATE TABLE "user_progresss" (
	"user_id" text PRIMARY KEY NOT NULL,
	"user_name" text DEFAULT 'User' NOT NULL,
	"user_image_src" text DEFAULT '/talking-person-svgrepo-com.svg' NOT NULL,
...
ALTER TABLE "user_progresss" ADD CONSTRAINT "user_progresss_active_course_id_courses_id_fk" FOREIGN KEY ("active_course_id") REFERENCES "public"."courses"("id") ON DELETE cascade ON UPDATE no action;