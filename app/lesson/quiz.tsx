...
export const Quiz = ({
  ...
  const [correctAudioEl, , correctControls] = useAudio({ src: "/correct.mp3" });
  const [incorrectAudioEl, , incorrectControls] = useAudio({ src: "/incorrect.mp3" });
  ...
  // Play finish audio once on completion
  useEffect(() => {
